CREATE DATABASE  IF NOT EXISTS `profile_and_product` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `profile_and_product`;
-- MySQL dump 10.13  Distrib 5.5.43, for debian-linux-gnu (x86_64)
--
-- Host: 127.0.0.1    Database: profile_and_product
-- ------------------------------------------------------
